...
const Widget03 = lazy(() => import('~/views/Pages/Widgets/Widget03'))
...
const Dashboard = () => {
  ...
  const [state, setState] = useState({dropdownOpen: false, radioSelected: 2})
